...
const DashboardLayout = ({ items, feeds }: Props) => {
  ...
  return (
    <div className={clsx("flex", "flex-col", "h-screen", "overflow-hidden", "w-screen")}>
      <header
        className={clsx(
          "bg-slate-200",
          "flex",
      ...
      >
        {!hideNavbar && (
          <div className={clsx("border-b-2", "flex", "items-center", "px-4", "w-80")}>
      ...
      <div className={clsx("flex", "flex-row", "h-full", "w-screen")}>
        <aside
          className={clsx(
            "bg-slate-200",
            "border-primary",
        ...
        >
          <div className={clsx("flex", "flex-1", "flex-col", "w-full")}>
            <div className={clsx("border-b", "border-gray-600", "mt-6", "pb-5", "pl-4", "w-full")}>
              <p className={clsx("font-bold", "leading-4", "text-primary", "underline")}>Reader</p>
        ...
        <main
          className={clsx("flex-1", "overflow-scroll", "px-10", "py-4")}
